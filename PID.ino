...
#define _DUTY_NEU 1450 // [2952] 서보의 중간 각도값
...
////////////////////
  ...
  // PID control logic
   ...
   down_control = pterm + dterm + iterm;     // 기울기가 +, -인지에 따라 _KP에 펄스폭 차이반영
   up_control = (1.2 * pterm) + dterm + iterm;
  ...
  if(event_serial) {
    ...
    Serial.print(",P");
    Serial.print(map(pterm,-1000,1000,510,610));  // 비례제어량 출력
    Serial.print(",D:");
    Serial.print(map(dterm,-1000,1000,510,610)); // [2961] 미분제어량 출력
    Serial.print(",I");
    Serial.print(map(iterm,-1000,1000,510,610));
    Serial.print(",DTT:"); 
    Serial.print(map(duty_target,1000,2000,410,510)); // [2957] 목표 거리 출력
    Serial.print(",DTC:"); 
